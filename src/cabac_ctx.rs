...
/// Table 9-20 field — ctxIdx 277..=340.
/// Field-coded significant_coeff_flag init values for ctxBlockCat 0-4.
/// Values from ITU-T H.264 Table 9-20 (field rows).
const TBL_9_20_FIELD: &[(usize, InitCell)] = &[
    (
        277,
        InitCell::all((-6, 93), (-13, 106), (-21, 126), (-22, 127)),
    ),
...
/// Table 9-20 field (last) — ctxIdx 338..=398.
/// Field-coded last_significant_coeff_flag init values for ctxBlockCat 0-4.
const TBL_9_20_FIELD_LAST: &[(usize, InitCell)] = &[
    (338, InitCell::all((15, 6), (14, 11), (19, -6), (17, -13))),
    (339, InitCell::all((6, 19), (11, 14), (18, -6), (16, -9))),
    (340, InitCell::all((7, 16), (9, 11), (14, 0), (17, -12))),
